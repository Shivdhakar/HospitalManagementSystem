...
struct Data {
  string name, address, disease, gender, description, specialRoomNo, age;
};
...
void printLinkedList(Node * head) {
  ...
  while (head -> next != NULL) {
    cout << "Name: " << head -> data.name << ", Address: " << head -> data.address << ", Gender: " <<
      head -> data.gender << ", Disease: " << head -> data.disease << ", Description: " << head -> data.description <<
      ", Age: " << head -> data.age << ", Specialist No: " << head -> data.specialRoomNo << endl;
    head = head -> next;
  }
  cout << "Name: " << head -> data.name << ", Address: " << head ->
    data.address << ", Gender: " << head -> data.gender << ", Disease: " << head ->
    data.disease << ", Description: " << head -> data.description << ", Age: " << head ->
    data.age << ", Specialist No: " << head -> data.specialRoomNo << endl;
...
Data inputPatients() {
  ...
  cin.ignore(); // clearing buffer     getline(cin, name);
...
int main() {
  ...
  n\ n3..Search Patient by Name\ n\ n4..List of admited Patient " <<
